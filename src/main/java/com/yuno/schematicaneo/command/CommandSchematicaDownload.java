...
import com.yuno.schematicaneo.util.FileUtils;
...
public class CommandSchematicaDownload extends CommandSchematicaBase {
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args) {
        ...
        final File directory = SchematicaNeo.proxy.getPlayerSchematicDirectory((EntityPlayer) sender, true);
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        final File directory = SchematicaNeo.proxy.getPlayerSchematicDirectory(player, true);
