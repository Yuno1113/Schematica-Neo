package com.yuno.schematicaneo.command;
...
public class CommandSchematicaSave extends CommandSchematicaBase {
    ...
    public void processCommand(ICommandSender sender, String[] arguments) {
        ...
        if (SchematicaNeo.proxy.isPlayerQuotaExceeded(player)) {
        ...
        final File schematicDirectory = SchematicaNeo.proxy.getPlayerSchematicDirectory(player, true);
        ...
        try {
            SchematicaNeo.proxy.saveSchematic(player, schematicDirectory, filename, player.getEntityWorld(), from, to);
