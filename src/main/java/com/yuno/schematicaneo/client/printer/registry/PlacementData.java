...
public class PlacementData {
    ...
    public PlacementData setManaMetalSlab() {
        this.manaMetalSlab = true;
        return this;
    }

    public float getOffsetFromMetadata(int metadata) {
        if (this.manaMetalSlab) return metadata == 1 ? this.offsetHighY : this.offsetLowY;
