package com.yuno.schematicaneo.proxy;
...
import com.yuno.schematicaneo.compat.ILOTRPresent;
import com.yuno.schematicaneo.compat.NoLOTRProxy;
import com.yuno.schematicaneo.handler.ConfigurationHandler;
import com.yuno.schematicaneo.handler.client.ChatEventHandler;
import com.yuno.schematicaneo.handler.client.InputHandler;
import com.yuno.schematicaneo.handler.client.OverlayHandler;
import com.yuno.schematicaneo.handler.client.RenderTickHandler;
import com.yuno.schematicaneo.handler.client.TickHandler;
import com.yuno.schematicaneo.handler.client.WorldHandler;
...
public class ClientProxy extends CommonProxy {
    ...
    public static boolean addCoordinatesAndRotation(String worldServerName, String schematicName, Integer X, Integer Y,
        ...
        try {
            ...
            if (coordinates.containsKey(worldServerName)) {
                ...
                coordinates.put(worldServerName, new HashMap<String, SchematicData>() {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        MinecraftForge.EVENT_BUS.register(SchematicEditorHandler.INSTANCE);
        FMLCommonHandler.instance().bus().register(SchematicEditorHandler.INSTANCE);
    }
    ...
    public static void replaceSchematic(ISchematic schematic, String name, int x, int y, int z, boolean rendering) {
        SchematicWorld world = new SchematicWorld(schematic);
        world.name = name;
        world.position.set(x, y, z);
        world.isRendering = rendering;
        ClientProxy.schematic = world;
        RendererSchematicGlobal.INSTANCE.destroyRendererSchematicChunks();
        RendererSchematicGlobal.INSTANCE.createRendererSchematicChunks(world);
        SchematicPrinter.INSTANCE.setSchematic(world);
