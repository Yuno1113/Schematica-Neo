...
public class ConfigurationHandler {
    ...
    public static final File SCHEMATIC_DIRECTORY_DEFAULT = new File(
        SchematicaNeo.proxy.getDataDirectory(),
    ...
    public static int placementsPerCycle = 1;
    ...
    public static void loadConfiguration() {
        ...
        try {
            ...
            final String dataPath = SchematicaNeo.proxy.getDataDirectory()
                .getAbsolutePath();
        ...
        SchematicaNeo.proxy.createFolders();
